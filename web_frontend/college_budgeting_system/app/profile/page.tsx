  ...
  return (
    <main className="flex min-h-screen flex-col items-center py-10 px-4 bg-slate-950 text-slate-200 font-sans selection:bg-blue-500/30">
      ...
      <div className="z-10 max-w-2xl w-full">
        {/* NAVBAR */}
        <div className="flex justify-center p-1.5 bg-slate-900/80 border border-slate-800 rounded-full mb-10 shadow-lg mx-auto w-fit gap-2">
          <Link href="/" className="px-6 py-2 hover:bg-slate-800 rounded-full font-bold text-slate-400 transition-all">🏠 Home</Link>
          <Link href="/riwayat" className="px-6 py-2 hover:bg-slate-800 rounded-full font-bold text-slate-400 transition-all">📂 Riwayat</Link>
          <Link href="/profile" className="px-6 py-2 bg-blue-600 rounded-full font-bold text-white shadow-lg transition-all">👤 Profil</Link>
        </div>
